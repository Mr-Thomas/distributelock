...
@Component
@Slf4j
public class ChannelMessageHandler implements ChannelAwareMessageListener {
    @Override
    public void onMessage(Message message, Channel channel) throws Exception {
        ...
        try {
            ...
            String trialId = routingKey.substring(routingKey.lastIndexOf(".") + 1);
