...
public class RedisUtil {
    ...
    @Autowired
    private RedisTemplate<String, String> limiterRedisTemplate;
     ...
     * @return
     */
    public Boolean redisLuaLimit(String key, String limit) {
        List<String> keys = Arrays.asList(key);
        //调用lua脚本
        return limiterRedisTemplate.execute(redisScript, keys, limit);
    }
